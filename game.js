...
const AUTHORED_SCENES = {
  0: {
    ...
    items: [
      ...
      { prop: 'birdbath', x: 111, y: 224 },
      { prop: 'bush', x: 221, y: 304 },
      ...
      { prop: 'bush', x: 172, y: 322 },
      { prop: 'lamppost', x: 115, y: 419 },
      { prop: 'lamppost', x: 738, y: 423 },
    ],
    mailbox: { x: 433, y: 269 }, dogSpawn: { x: 364, y: 318 },
  },
  1: {
    key: 'lot2', w: LOT_W, h: LOT_H, sidewalkY: 394,
    items: [
      { prop: 'house2', x: 360, y: 258 },
      { prop: 'bush', x: 162, y: 352 },
      { prop: 'rock', x: 456, y: 346 },
      { prop: 'bush', x: 566, y: 309 },
      { prop: 'birdbath', x: 652, y: 188 },
      { prop: 'bush', x: 106, y: 107 },
      { prop: 'rock', x: 190, y: 271 },
      { prop: 'bush', x: 259, y: 230 },
      { prop: 'rock', x: 547, y: 167 },
      { prop: 'bush', x: 126, y: 322 },
      { prop: 'lamppost', x: 74, y: 418 },
    ],
    mailbox: { x: 453, y: 217 }, dogSpawn: { x: 380, y: 301 },
  },
  2: {
    key: 'lot3', w: LOT_W, h: LOT_H, sidewalkY: 394,
    items: [
      { prop: 'house3', x: 154, y: 322, scale: 1.56 },
      { prop: 'bush', x: 169, y: 387 },
      { prop: 'rock', x: 302, y: 157 },
      { prop: 'bush', x: 471, y: 146 },
      { prop: 'birdbath', x: 46, y: 382, scale: 1.06 },
      { prop: 'bush', x: 601, y: 315 },
      { prop: 'rock', x: 306, y: 334 },
      { prop: 'bush', x: 424, y: 170 },
      { prop: 'rock', x: 657, y: 165 },
      { prop: 'bush', x: 554, y: 354 },
      { prop: 'birdbath', x: 504, y: 266, scale: 1.29 },
      { prop: 'rock', x: 359, y: 81 },
      { prop: 'lamppost', x: 706, y: 418 },
    ],
    mailbox: { x: 300, y: 243 }, dogSpawn: { x: 439, y: 307 },
  },
  3: {
    key: 'lot4', w: LOT_W, h: LOT_H, sidewalkY: 394,
    items: [
      { prop: 'house1', x: 565, y: 329, scale: 1.53 },
      { prop: 'bush', x: 212, y: 389 },
      { prop: 'rock', x: 143, y: 171 },
      { prop: 'bush', x: 427, y: 392 },
      { prop: 'bush', x: 406, y: 256 },
      { prop: 'rock', x: 145, y: 316 },
      { prop: 'bush', x: 743, y: 191, scale: 1.05 },
      { prop: 'rock', x: 713, y: 396 },
      { prop: 'bush', x: 212, y: 250 },
      { prop: 'birdbath', x: 301, y: 319, scale: 1.11 },
      { prop: 'lamppost', x: 74, y: 418 },
    ],
    mailbox: { x: 726, y: 277 }, dogSpawn: { x: 568, y: 372 },
  },
  4: {
    key: 'lot5', w: LOT_W, h: LOT_H, sidewalkY: 394,
    items: [
      { prop: 'house2', x: 121, y: 311, scale: 1.41 },
      { prop: 'bush', x: 375, y: 127 },
      { prop: 'rock', x: 248, y: 258 },
      { prop: 'bush', x: 413, y: 393 },
      { prop: 'birdbath', x: 515, y: 244, scale: 1.22 },
      { prop: 'bush', x: 447, y: 169 },
      { prop: 'rock', x: 314, y: 391 },
      { prop: 'bush', x: 303, y: 163 },
      { prop: 'rock', x: 251, y: 388 },
      { prop: 'bush', x: 257, y: 319 },
      { prop: 'birdbath', x: 512, y: 339, scale: 1.14 },
      { prop: 'lamppost', x: 627, y: 418 },
    ],
    mailbox: { x: 247, y: 187 }, dogSpawn: { x: 349, y: 290 },
  },
};
